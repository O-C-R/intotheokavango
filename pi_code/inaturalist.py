...
redirect = 'https://floodwatch.o-c-r.org/'
...
#Construct the species object
payload = {
    'observation[species_guess]': props['SpeciesName'], # WILL NEED TO BE CHANGED TO SPECIES NAME?
...
r = oath.post(site + "/observation_photos.json", data=photoPayload, files=photos)
projectPayload = {"project_observation[observation_id]" : observation_id, "project_observation[project_id]" : 800}
r = oath.post(site  + "/project_observations.json", data=projectPayload)
